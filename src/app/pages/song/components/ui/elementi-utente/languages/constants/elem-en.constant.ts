...
export const elemLang: ElemLang = {
  ...
  tipo: 'Type',
  selezionaTipo: 'Select type',
  manga: 'Manga',
  canzone: 'Song',
  titoloObbligatorio: 'Title is required',
  nome: 'Name',
  nomeObbligatorio: 'Name is required',
  descrizione: 'Description',
  descrizioneObbligatoria: 'Description is required',
  fileObbligatorio: 'File is required',
  fileAccettati: 'Only PDF or MP3 files are accepted',
  formatiAccettati: 'Accepted formats: PDF for books, MP3 for music',
  annulla: 'Cancel',
  invia: 'Submit',
};
